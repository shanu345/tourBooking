...
<script src="bootstrap/js/jquery-migrate-1.1.1.js"></script>
<script src="bootstrap/js/superfish.js"></script>
<script src="bootstrap/js/sForm.js"></script>
<script src="bootstrap/js/jquery.jqtransform.js"></script>
<script src="bootstrap/js/jquery.equalheights.js"></script>
<script src="bootstrap/js/jquery.easing.1.3.js"></script>
<script src="bootstrap/js/tms-0.4.1.js"></script>
